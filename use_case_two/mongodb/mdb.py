...
class MDB:
  ...
  def delete_one(self, db, coll: str, document: dict) -> Any:
    """ Delete a document
    ...
    """
    return self.__client[db][coll].delete_one(document)
  ...
  def encrypted_find_one(self, db, coll: str, document: dict) -> Any:
    ...
    try:
      ...
      return result
    except <UPDATE_HERE> as e: # Put code here to handle errors from not finding the DEK
  ...
  def delete_dek(self, dek_alt_name: str) -> Union[None, DeleteResult]:
    """ Delete a DEK
